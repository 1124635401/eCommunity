	...
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="报修单号" prop="baoxiudanhao">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="处理情况" prop="chuliqingkuang">
					<el-input v-model="ruleForm.chuliqingkuang" placeholder="处理情况" clearable  :readonly="ro.chuliqingkuang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="处理情况" prop="chuliqingkuang">
					<el-input v-model="ruleForm.chuliqingkuang" placeholder="处理情况" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='chuliqingkuang'){
							this.ruleForm.chuliqingkuang = obj[o];
							this.ro.chuliqingkuang = true;
							continue;
						}
