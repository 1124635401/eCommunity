<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="公告标题" prop="gonggaobiaoti">
					<el-input v-model="ruleForm.gonggaobiaoti" placeholder="公告标题" clearable  :readonly="ro.gonggaobiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="公告标题" prop="gonggaobiaoti">
					<el-input v-model="ruleForm.gonggaobiaoti" placeholder="公告标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="select" v-if="type!='info'"  label="公告类型" prop="gonggaoleixing">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="公告类型" prop="gonggaoleixing">
					<el-input v-model="ruleForm.gonggaoleixing"
						placeholder="公告类型" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.gonggaotupian" label="公告图片" prop="gonggaotupian">
					<file-upload
						tip="点击上传公告图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-else-if="ruleForm.gonggaotupian" label="公告图片" prop="gonggaotupian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-if="type!='info'"  label="公告内容" prop="gonggaoneirong">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.gonggaoneirong" label="公告内容" prop="gonggaoneirong">
...
export default {
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.gonggaoneirong = this.ruleForm.gonggaoneirong.replace(reg,'../../../ecommunity/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
