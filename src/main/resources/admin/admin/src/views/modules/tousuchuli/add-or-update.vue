<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="投诉单号" prop="tousudanhao">
					<el-input v-model="ruleForm.tousudanhao" placeholder="投诉单号" clearable  :readonly="ro.tousudanhao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="投诉单号" prop="tousudanhao">
					<el-input v-model="ruleForm.tousudanhao" placeholder="投诉单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="投诉标题" prop="tousubiaoti">
					<el-input v-model="ruleForm.tousubiaoti" placeholder="投诉标题" clearable  :readonly="ro.tousubiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="投诉标题" prop="tousubiaoti">
					<el-input v-model="ruleForm.tousubiaoti" placeholder="投诉标题" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="处理内容" prop="chulineirong">
					<el-input v-model="ruleForm.chulineirong" placeholder="处理内容" clearable  :readonly="ro.chulineirong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="处理内容" prop="chulineirong">
					<el-input v-model="ruleForm.chulineirong" placeholder="处理内容" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="处理日期" prop="chuliriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.chuliriqi" label="处理日期" prop="chuliriqi">
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='tousudanhao'){
							this.ruleForm.tousudanhao = obj[o];
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tousuchuli/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tousuchuliCrossAddOrUpdateFlag = false;
						 this.parent.search();
