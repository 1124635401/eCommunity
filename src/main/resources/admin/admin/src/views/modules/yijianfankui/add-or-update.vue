<template>
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="反馈标题" prop="fankuibiaoti">
					<el-input v-model="ruleForm.fankuibiaoti" placeholder="反馈标题" clearable  :readonly="ro.fankuibiaoti"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else class="input" label="反馈标题" prop="fankuibiaoti">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="反馈日期" prop="fankuiriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.fankuiriqi" label="反馈日期" prop="fankuiriqi">
					<el-input v-model="ruleForm.fankuiriqi" placeholder="反馈日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="textarea" v-if="type!='info'" label="意见内容" prop="yijianneirong">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="意见内容"
					  v-model="ruleForm.yijianneirong" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.yijianneirong" label="意见内容" prop="yijianneirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.yijianneirong}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.fankuiriqi = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yijianneirong'){
							this.ruleForm.yijianneirong = obj[o];
							this.ro.yijianneirong = true;
							continue;
						}
				}
