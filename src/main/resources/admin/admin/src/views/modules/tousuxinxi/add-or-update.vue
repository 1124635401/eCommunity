	...
	<div class="addEdit-block" :style='{"padding":"0"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.tousudanhao" label="投诉单号" prop="tousudanhao">
					<el-input v-model="ruleForm.tousudanhao" placeholder="投诉单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-if="type!='info' && !ro.tousutupian" label="投诉图片" prop="tousutupian">
					<file-upload
						tip="点击上传投诉图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="upload" v-else-if="ruleForm.tousutupian" label="投诉图片" prop="tousutupian">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="date" v-if="type!='info'" label="投诉日期" prop="tousuriqi">
					<el-date-picker
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="input" v-else-if="ruleForm.tousuriqi" label="投诉日期" prop="tousuriqi">
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' class="textarea" v-if="type!='info'" label="投诉内容" prop="tousuneirong">
					<el-input
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 16px 0","background":"none","display":"inline-block"}' v-else-if="ruleForm.tousuneirong" label="投诉内容" prop="tousuneirong">
