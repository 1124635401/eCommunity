...
public class YijianfankuiController {
    ...
    public R page(@RequestParam Map<String, Object> params,YijianfankuiEntity yijianfankui,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date fankuiriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd HH:mm:ss") Date fankuiriqiend,
		HttpServletRequest request){
		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("yezhu")) {
			yijianfankui.setYonghuming((String)request.getSession().getAttribute("username"));
		}
