...
public class BaoxiuchuliController {
    ...
    public R page(@RequestParam Map<String, Object> params,BaoxiuchuliEntity baoxiuchuli,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date chuliriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date chuliriqiend,
        ...
        EntityWrapper<BaoxiuchuliEntity> ew = new EntityWrapper<BaoxiuchuliEntity>();
                if(chuliriqistart!=null) ew.ge("chuliriqi", chuliriqistart);
                if(chuliriqiend!=null) ew.le("chuliriqi", chuliriqiend);
